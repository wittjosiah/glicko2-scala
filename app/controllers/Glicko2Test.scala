...
class Glicko2Test {
  ...
  def Test2(): Unit = {
    ...
    val matches = List(new Match(player1, player2, false), new Match(player1, player2, false), new Match(player1, player2, false), new Match(player1, player2, false), new Match(player1, player2, false))
    println(player1)
    println(player2)
